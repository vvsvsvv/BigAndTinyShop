...
urlpatterns = [
    ...
    path('productcategory/update/<int:pk>/', adminapp.ProductCategoryUpdateView.as_view(), name='productcategory_update'),
    # path('productcategory/delete/<int:pk>/', adminapp.productcategory_delete, name='productcategory_delete'),
    path('productcategory/delete/<int:pk>/', adminapp.ProductCategoryDeleteView.as_view(), name='productcategory_delete'),
    ...
    path('product/read/<int:pk>/', adminapp.ProductDetialView.as_view(), name='product_read'),
